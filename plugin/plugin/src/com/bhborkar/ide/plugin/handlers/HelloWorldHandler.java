package com.bhborkar.ide.plugin.handlers;
...
import com.bhborkar.ide.library.App;
import com.bhborkar.ide.osgi.OSGIDependency;
...
public class HelloWorldHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_SHELL) Shell s) {
		...
		MessageDialog.openInformation(s, "E4 Information Dialog", new App().get() + ", "+ new OSGIDependency().get());
